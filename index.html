...
<head>
    ...
    <title>Churrasco com Amigo Secreto 🎁</title>
...
<body>
    ...
    <div class="container">
        <header>
            <h1>CONFRATERNIZAÇÃO - AMIGOS DO WANDA</h1>
         </header>
        ...
        <section class="detalhes">
            ...
            <div class="info-item">
                ...
                <p><strong>Rua das árvores, 71 - Parque Continental 2</strong> </p>
            </div>
            
            <div class="info-item">
                <span class="icon">📅</span>
                <p><strong>Data/Hora:</strong> 14 de Dezembro (Domingo) apartir dàs 11h00</p>
            </div>
            
            <div class="info-item">
                <span class="icon">💳</span>
                <p><strong>Valor Base p/ Pessoa:</strong> R$ 50,00</p>
            </div>
            
            <div class="info-item" id="pix-info">
                <span class="icon">🔑</span>
                <p><strong>Custo R$ 50,00:</strong> Apenas aluguel do local.</p>
            </div>
            
            <div class="info-item">
                <span class="icon">💰</span>
                <p><strong>PIX:</strong> 11 94077-0217 (Celular do Rogerio)</p>
            </div>
            
            <div class="info-item">
                <span class="icon">🎁</span>
                <p><strong>Amigo Secreto:</strong> At&eacute; R$ 30,00</p>
            </div>

            <div class="info-item" id="contribuicao">
                <span class="icon">🍴</span>
                <p><strong>Sua Contribui&ccedil;&atilde;o:</strong> Cada um deve levar o que ir&aacute; consumir: bebidas (cerveja, refri, &aacute;gua) e comida para churrasco (carne, lingui&ccedil;a, frango, p&atilde;o de alho, arroz, sobremesa, etc.).</p>
            </div>
        </section>
        ...
        <section class="confirmacao">
            ...
            <form id="confirmacao-form">
                ...
                <label for="acompanhantes">N&uacute;mero de Acompanhantes (M&aacute;x 10):</label>
        ...
        <div class="footer-id">
             ID da Festa: uzppMbpJjucjqzJEZQLNZKHSVcI2
        </div>
...
<script src="https://www.gstatic.com/firebasejs/8.10.0/firebase-app.js"></script>
    ...
    <script>
        ...
        const firebaseConfig = {
            ...
            // measurementId (G-30NV4J3B96) não é necessário para o Firestore
        };
        
        // Inicializa o Firebase (usando a sintaxe da v8)
        const app = firebase.initializeApp(firebaseConfig);
        const db = firebase.firestore(); // <--- ISTO É CRÍTICO!
